...
Incident write-ups: a bug reached a place it shouldn't have (a real user, a merged PR, a release), and the interesting part is _why our process let it through_, not just the one-line fix.
