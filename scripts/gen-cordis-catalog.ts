...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  nativeExecution: 'subprocess.md',
  recovery: 'llm-streaming.md',
  runtimePolicy: 'tools.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  NativeExecutionHello: 'subprocess.md',
  NativeProcessHandle: 'subprocess.md',
  NativeProcessSpawnSpec: 'subprocess.md',
  ...
  ModelRoute: 'llm-streaming.md',
  RecoveryHandler: 'llm-streaming.md',
  RecoveryHandlerOptions: 'llm-streaming.md',
  RecoveryRequest: 'llm-streaming.md',
  RecoveryResolution: 'llm-streaming.md',
  ...
  BudgetVector: 'tools.md',
  CapabilityPermissionSnapshot: 'tools.md',
  CapabilityRequirement: 'tools.md',
  ExecutionWorldSnapshot: 'tools.md',
  GlobalBudgetSnapshot: 'tools.md',
  ResolvedRuntimeConfigSnapshot: 'tools.md',
  RuntimeDelegationSnapshot: 'tools.md',
  RuntimeSnapshotRefs: 'tools.md',
  ToolRequirementClassifier: 'tools.md',
  ToolRequirementClassifierOptions: 'tools.md',
